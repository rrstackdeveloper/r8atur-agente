...
body{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;background:#f0f2f5;height:100vh;height:var(--app-height,100vh);display:flex;flex-direction:column}
...
#app{display:none;height:100vh;height:var(--app-height,100vh);flex-direction:column}
